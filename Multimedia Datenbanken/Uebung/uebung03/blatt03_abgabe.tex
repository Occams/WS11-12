...
\subsection{} \textit{Skizzieren Sie die wichtigsten Eigenschaften der Bildformate GIF, PNG und JPEG. Berückusichtigen Sie dabei folgende Dimensionen: Farbmodelle, Farbtiefe, Kompression, Dateigröße.}

\mysection{Aufgabe 3: Bildmanipulation unter Java}
\subsection{} \textit{Entwerfen Sie eine Java-Klasse, die pixelbasierte Operationen auf ein digitales Bild ermögliochen soll. Achten Sie dabei insbesondere auf folgende Punkte:
\begin{itemize}
	\item Attribute
	\item Grundsätzliche Methoden
