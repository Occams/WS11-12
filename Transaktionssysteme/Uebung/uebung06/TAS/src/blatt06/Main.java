...
public class Main {
	...
	private static final String url = 
		"jdbc:postgresql://alexandria.ifis.uni-passau.de:5432/db";
...
//		"com.ibm.db2.jcc.DB2Driver";
	 ...
	 */
	private static final int isolation = 
	...
	/**
	 * Resets the database.
	 * Creates a table "data" with two columns, "id" and "value".
	 * Inserts three tuples into the table "data", 
	 * ('x', 7), ('y', 13) and ('z', 42).
	 */
	...
	private static void lostUpdate() throws Exception {
		Transaction T1 = 
			new Transaction(1, url, user, password, driver, isolation);
		Transaction T2 = 
			new Transaction(2, url, user, password, driver, isolation);
